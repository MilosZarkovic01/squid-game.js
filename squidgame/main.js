...
//Creating runway
createCube({w: start_position * 2 + .21, h: 3.2, d: 1}, 0, 0, 0xe5a716).position.z = -1
createCube({w: .2, h: 3.2, d: 1}, start_position, -.4)
createCube({w: .2, h: 3.2, d: 1}, end_position, .4)
...
const player1 = new Player("Zeleni", .25, .9, 0xD1FFC6)
const player2 = new Player("Somika", .25, .3, 0xFFCFD2)
const player3 = new Player("Dobri", .25, -.3, 0xCC66FF)
const player4 = new Player("Profesor", .25, -.9, 0xFF3300)
